 ...
 * @returns {undefined}
 */
Oxford.prototype._oxfordParseResponse = function (response, callback) {
        var emotion;
        var err;
 ...
 * @returns {undefined}
 */
Oxford.prototype._getEmotionFromOxford = function (image, callback) {
        var self = this;
        //API setup
        ...
        return request({
            ...
            headers: {
                ...
                self._oxfordParseResponse(response, callback);
...
Oxford.prototype.recognizeImageB64 = function (imageB64, callback) {
        ...
        return self._getEmotionFromOxford(buf, callback);
};
